...
ANIMATION_ATTACK_UP = ['Drawable/hero/attack_up1.png',
                       ...
                       'Drawable/hero/attack_up6.png',
                       'Drawable/hero/attack_up7.png']
...
ANIMATION_ATTACK_DOWN = ['Drawable/hero/attack_down1.png',
                         ...
                         'Drawable/hero/attack_down6.png',
                         'Drawable/hero/attack_down7.png']
...
ANIMATION_ATTACK_RIGHT = ['Drawable/hero/attack_right1.png',
                          ...
                          'Drawable/hero/attack_right6.png',
                          'Drawable/hero/attack_right7.png']
...
ANIMATION_ATTACK_LEFT = ['Drawable/hero/attack_left1.png',
                         ...
                         'Drawable/hero/attack_left6.png',
                         'Drawable/hero/attack_left7.png']
...
ANIMATION_MOVE_UP = ['Drawable/hero/move_up1.png',
                     ...
                     'Drawable/hero/move_up7.png',
                     'Drawable/hero/move_up8.png']
ANIMATION_MOVE_DOWN = ['Drawable/hero/move_down1.png',
                       ...
                       'Drawable/hero/move_down7.png',
                       'Drawable/hero/move_down8.png']
ANIMATION_MOVE_RIGHT = ['Drawable/hero/move_right1.png',
                        ...
                        'Drawable/hero/move_right7.png',
                        'Drawable/hero/move_right8.png']
ANIMATION_MOVE_LEFT = ['Drawable/hero/move_left1.png',
                       ...
                       'Drawable/hero/move_left7.png',
                       'Drawable/hero/move_left8.png']